...
$paypal_email = 'madhurabhagwat31@gmail.com';
$return_url = $CFG->wwwroot.'/enrol/paypal/payment-successful.php?id='.$data->courseid ;
...
if (!isset($_POST["txn_id"]) && !isset($_POST["txn_type"])){
    ...
    $querystring .= "return=".urlencode($notify_url);
    
    // Append querystring with custom field
    //$querystring .= "&custom=".USERID;
    
    // Redirect to paypal IPN
// echo 'query--->'.$querystring;exit;
    // echo 'https://www.sandbox.paypal.com/cgi-bin/webscr'.$querystring;exit;
    header('location:https://www.sandbox.paypal.com/cgi-bin/webscr'.$querystring);
    exit();
} else {
/// Open a connection back to PayPal to validate the data
$paypaladdr = empty($CFG->usepaypalsandbox) ? 'www.paypal.com' : 'www.sandbox.paypal.com';
    // $paypaladdr = fsockopen ('ssl://www.sandbox.paypal.com', 443, $errno, $errstr, 30);
...
//     if (strcmp($result, "VERIFIED") == 0) {          // VALID PAYMENT!
    ...
    // }
// }
        header('location:'.$CFG->wwwroot.'/enrol/paypal/return.php?id='.$data->courseid);
}
// exit;
