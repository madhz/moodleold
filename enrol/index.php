...
$sql="SELECT * FROM mdl_course_sections WHERE course=$id and section=1";
$result= $DB->get_record_sql($sql);
// echo '<pre>';
// print_r($result);
// $result=$DB->execute($sql);
$out.='<div><h2>Topic 1</h2></div>';
$out.='<div><h3 style="color:#6495ED";>&nbsp;'.$result->name.'</h3></div>';
$out.='<div><p>'.$result->summary.'</p></div>';
echo $out;
$p.='<div width=50%><marquee><b>Click on BUY to access whole course</b></marquee></div>';
echo $p;
